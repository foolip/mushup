...
function paint() {
    ...
    putCover(ctx, coverImages[0], -300, 20, 120);
    putCover(ctx, coverImages[1], -160, 20, 120);
    putCover(ctx, coverImages[2], 0, 0, 160);
    putCover(ctx, coverImages[3], 160, 20, 120);
    putCover(ctx, coverImages[4], 300, 20, 120);
    ctx.restore();
}
